import { CanvasCoords, GameViewport, RGBAVec, WorldCoords } from '@darkforest_eth/types';
...
export class CircleRenderer extends GenericRenderer<typeof CIRCLE_PROGRAM_DEFINITION> {
  quadBuffer: number[];
